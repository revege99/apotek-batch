    ...
    public function create(Request $request): View
    {
        return view('purchases.create', [
            ...
            'initialForm' => [
                ...
                'default_expiry_date' => now()->toDateString(),
    ...
    private function initialItems(Request $request, ?PurchaseInvoice $purchaseInvoice = null): array
    {
        ...
        foreach ($rawItems as $index => $item) {
            ...
            $rows[] = [
                ...
                'expiry_date' => (string) (filled($item['expiry_date'] ?? null) ? $item['expiry_date'] : now()->toDateString()),
        ...
        $normalizedItems = collect($items)
            ...
            ->map(function (array $item) use ($medicines): array {
                ...
                return [
                    ...
                    'expiry_date' => $item['expiry_date'] ?: now()->toDateString(),
                    'quantity' => $quantity,
