        ...
        <div class="panel-surface px-5 py-3">
            <div class="flex flex-wrap items-center gap-2.5">
                <div class="inline-flex items-center gap-2 rounded-full bg-slate-100 px-4 py-2 text-[0.78rem] text-slate-700">
                    <span class="font-medium">Faktur lunas</span>
        ...
        <section class="panel-surface overflow-hidden p-0">
            <div class="border-b border-slate-200/80 px-5 py-4">
                <div class="flex flex-wrap items-center justify-between gap-3">
                    <h3 class="section-title">Riwayat piutang per pelanggan</h3>
                    ...
                    <form method="GET" action="{{ route('keuangan.riwayat-pembayaran') }}" class="flex w-full max-w-4xl flex-wrap items-center gap-2 lg:w-auto lg:flex-nowrap">
                        ...
                        <input
                            ...
                            type="text"
                            value="{{ $search }}"
                            placeholder="Cari pelanggan, no faktur, no bayar, referensi"
                        ...
                        @forelse ($customers as $index => $row)
                            <tr class="align-top">
                                ...
                                <td class="px-3 py-3">
                                    ...
                                    <p class="mt-1 text-[0.66rem] text-slate-400">Pelanggan dengan riwayat piutang</p>
                                </td>
                                ...
                                <td class="px-3 py-3 align-middle">
                                    <div class="table-action-group justify-center">
                                        <button
                                            ...
                                            title="Lihat riwayat faktur {{ $row->customer_name }}"
                                            aria-label="Lihat riwayat faktur {{ $row->customer_name }}"
                                        >
                                            ...
                                            <span class="sr-only">Lihat riwayat faktur pelanggan</span>
                                        </button>
                                    </div>
                                </td>
                            </tr>
